	...
	return (
		<Popover>
			<PopoverTrigger asChild>
				<button
					className={`flex border rounded-lg px-4 py-2 border-gray-200 min-w-67 ${
				...
				>
					...
					<div className="flex flex-1 gap-3">
						...
						<MoveRight
							className={`${hasDates ? "text-gray-900" : "text-gray-500"}`} />
						<span>
			...
			<PopoverContent alignOffset={-40} align="end" sideOffset={10}>
